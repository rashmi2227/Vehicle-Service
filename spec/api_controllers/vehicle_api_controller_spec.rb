...
RSpec.describe Api::VehiclesController , type: :request do
    ...
    describe "get/vehicles #welcome" do
        ...
        context "When signed in as customer" do
            it "redirects to user profile page" do
                get "/api/vehicles/create", params: {access_token: customer_token.token, user_id: customer_user.id,  vehicle: {vehicle_modal: "SUV", color: "crimson red", purchase_date: "2023-04-24", vehicle_number: "TN 37 CB 3829", make: "Benz", user_id: customer_user.id}}
    ...
    describe "patch/vehicles #welcome" do
        ...
        context "When signed in as customer" do
            it "redirects to user profile page" do
                patch "/api/vehicles/#{vehicle.id}", params: {access_token: customer_token.token, vehicle: {vehicle_modal: "SUV", color: "crimson red", purchase_date: "2023-04-24", vehicle_number: "TN 37 CB 3829", make: "Benz"}}
